...
export default function DisplayAccounts() {
    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                console.log("res on display:", response.data);
                ...
                // console.log("err on display:", error.response);
    ...
    }, [dispatch, navigate, username, googleId])
    ...
    console.log("google id:", googleId, "and username:", username);
